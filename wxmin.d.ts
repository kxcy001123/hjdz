/**
 * @see https://github.com/pony13500815917/rose/blob/master/library/wxmini/bin/wxmini.d.ts
 * @update 2019/11/6
 */
...
declare namespace wx {
  ...
  function onShareAppMessage(
    callback: (res: { title: string; imageUrl: string; query: string }) => void
  ): void;
  ...
  interface FileSystemManager {
    ...
    getSavedFileList(object: {
      success?: (res: {
        fileList: Array<{ filePath: string; size: number; createTime: number }>;
      }) => void;
      fail?: (res?: any) => void;
      complete?: (res?: any) => void;
    }): void;
  ...
  function onDeviceMotionChange(
    callback: (res: { alpha: number; beta: number; gamma: number }) => void
  ): void;
  ...
  namespace cloud {
    ...
    function init(options?: {
      env?:
        | string
        | { database?: string; storage?: string; functions?: string };
      traceUser?: false;
    }): void;
    ...
    function deleteFile(obj: {
      ...
      config?: cloudEnvType;
      success: (
        fileList: Array<{ fileID: string; status: number; errMsg: string }>
      ) => void;
      fail?: cloudCallFailType;
      complete?: cloudEmptyFunction;
    }): void;
